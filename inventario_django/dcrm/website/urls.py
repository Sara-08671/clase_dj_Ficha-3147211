...
urlpatterns = [
    ...
    path('notificaciones/admin/crear/', views.notificacion_crear, name='notificacion_crear'),
    path('notificaciones/admin/<int:pk>/editar/', views.notificacion_admin_editar, name='notificacion_admin_editar'),
    path('notificaciones/admin/<int:pk>/eliminar/', views.notificacion_eliminar, name='notificacion_admin_eliminar'),
    path('notificaciones/organizador/', views.notificaciones_organizador, name='notificaciones_organizador'),
    path('notificaciones/organizador/crear/', views.notificacion_organizador_crear, name='notificacion_organizador_crear'),
    path('notificaciones/organizador/<int:pk>/editar/', views.notificacion_organizador_editar, name='notificacion_organizador_editar'),
    path('notificaciones/organizador/<int:pk>/eliminar/', views.notificacion_organizador_eliminar, name='notificacion_organizador_eliminar'),
    ...
    path('notificaciones/<int:pk>/no-leida/', views.notificacion_marcar_no_leida, name='notificacion_marcar_no_leida'),
